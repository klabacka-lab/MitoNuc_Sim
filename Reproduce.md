...
First, set up the Python virtual environemnt with the setup script:
...
The files written by the above command can be used to generate the figures in the paper. They can be passed into the python script "figure_maker.py".
